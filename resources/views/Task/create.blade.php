<x-app-layout>
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6">Create Task</h1>
        ...
        <form action="{{ route('tasks.store') }}" method="POST" class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow max-w-md">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="4"
                          class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="mb-4 flex items-center space-x-2">
                <input type="checkbox" name="completed_at" id="completed_at" value="{{ now() }}">
